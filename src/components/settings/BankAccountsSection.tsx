      ...
      {showForm && (
        <form onSubmit={handleAdd} className="mt-5 space-y-3 rounded-xl bg-white/5 p-4">
          ...
          <button
            type="submit"
            disabled={saving}
            className="rounded-full bg-gradient-to-r from-accent-500 to-violet-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-accent-500/25 transition-transform hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-60"
          >
