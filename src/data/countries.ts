/**
 * Lista de países en español, ordenada alfabéticamente. Se usa en los
 * selectores de país del onboarding y de Ajustes (freelancer/voluntario/
 * reclutador), para evitar errores de tipeo y estandarizar el dato.
 */
